<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      >
        <tr>
          <th scope="col" class="px-6 py-3">رقم الاعلان</th>
          <th scope="col" class="px-6 py-3">صورة الاعلان</th>
          <th scope="col" class="px-6 py-3">اسم الاعلان</th>
          <th scope="col" class="px-6 py-3">عنوان الاعلان</th>
          <th scope="col" class="px-6 py-3">حاله الاعلان</th>
        ...
        >
          ...
          <td class="px-6 py-4">
            <img :src="'/uploads/' + ad.image" alt="" class="w-20" />
          </td>
          <th
            scope="row"
            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap"
          ...
          <td class="px-6 py-4">
            <router-link
              :to="{ name: 'EditMarketing', params: { id: ad.id || 1 } }"
            >
              <a
                type="button"
...
export default {
  ...
  computed: {
    ...mapGetters(["allAds"]),
    filtered() {
      return this.allAds?.filter((item) => {
